...
async function loadDashboard() {
    ...
    try {
        ...
        // Update Hero Stats
        // Update Hero Stats
        const targetCalories = (user.metrics && user.metrics.dailyCalories) ? user.metrics.dailyCalories : 1500;
        ...
        if (document.getElementById('caloriesBurned')) {
            ...
            if (document.getElementById('calorieTarget')) {
                document.getElementById('calorieTarget').innerText = `/ ${targetCalories}`;
            }
